    ...
    return(
        <div className="body">
            ...
            <nav className="main">
                ...
                <div className="tt">
                    <a href="/home" className="but" id="butt">TT Essential</a>
                    <a href="" className="but" id="but">TT Gig</a>
                </div>
                <div className="log">
             ...
             <h1 className="RJ">Unleash Your <span>TrueTalent</span> with Every Gig</h1>
             <p className="career">Your next carrer move starts here</p>
                </div>  
            </div>
            <div className="rht">
            <div className="butn">
                <button className="btn" id="btn"onClick={this.colorhandler} style={{backgroundColor:this.state.colr}}>Search Gigs</button>
            ...
            <SlMagnifier></SlMagnifier>
                <input type="text" placeholder="Skill/Gigs roles" className="in-inp"/>
            </div>
                <div className="sear">
